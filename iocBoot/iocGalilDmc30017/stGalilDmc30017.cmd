...
dbLoadRecords("$(TOP)/db/GalilHighLevel.db", "P=$(PREFIX), M=$(M), EGU=$(EGU), MTRTYPE=$(MTRTYPE), MTRON=$(MTRON), AMP_GAIN=$(AMP_GAIN), DIR=$(DIR), ENC_TYPE=$(ENC_TYPE), PREC=$(PREC), BISS_POLL=$(BISS_POLL), BISS_CLKDIV=$(BISS_CLKDIV), BISS_DATA1=$(BISS_DATA1), BISS_DATA2=$(BISS_DATA2), BISS_ZEROPAD=$(BISS_ZEROPAD), BISS_INPUT=$(BISS_INPUT), BISS_LEVEL=$(BISS_LEVEL), DIG_OUT0=$(DIG_OUT0), DIG_OUT1=$(DIG_OUT1), DIG_OUT2=$(DIG_OUT2), DIG_OUT3=$(DIG_OUT3), DIG_IN0=$(DIG_IN0), DIG_IN1=$(DIG_IN1), DIG_IN2=$(DIG_IN2), DIG_IN3=$(DIG_IN3), DIG_IN4=$(DIG_IN4), DIG_IN5=$(DIG_IN5), DIG_IN6=$(DIG_IN6), DIG_IN7=$(DIG_IN7), ANALOG_OUT0=$(ANALOG_OUT0), ANALOG_OUT1=$(ANALOG_OUT1), ANALOG_IN0=$(ANALOG_IN0), ANALOG_IN1=$(ANALOG_IN1)")
